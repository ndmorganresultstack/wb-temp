...
interface ExternalLaborStatsProps {
...
export default function ExternalLaborStats({ totalEmployees, active, terminated, vacant, averageTOS }: ExternalLaborStatsProps) {
  return (
